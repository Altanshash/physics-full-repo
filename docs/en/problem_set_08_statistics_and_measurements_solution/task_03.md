...
The density of a rectangular cuboid is determined by:
...
$$d\rho = \frac{\partial \rho}{\partial m}dm + \frac{\partial \rho}{\partial a}da + \frac{\partial \rho}{\partial b}db + \frac{\partial \rho}{\partial c}dc$$
...
$$u(\rho) = \left|\frac{\partial \rho}{\partial m}\right|u(m) + \left|\frac{\partial \rho}{\partial a}\right|u(a) + \left|\frac{\partial \rho}{\partial b}\right|u(b) + \left|\frac{\partial \rho}{\partial c}\right|u(c)$$

After dividing by the density:
...
$$\frac{u(\rho)}{\rho} = 0.00156 + 0.00385 + 0.00952 + 0.00667$$
...
The largest contribution to the uncertainty comes from the measurement of dimension b, because:

$$\frac{u(b)}{b} = 0.00952$$

This value is greater than the other relative uncertainty contributions. Therefore, the accuracy of the density measurement mainly depends on the accuracy of measuring dimension b.
